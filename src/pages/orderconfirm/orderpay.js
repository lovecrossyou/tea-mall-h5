...
const PayChannel = ({ icon, title = "", selIcon,unselIcon,selelcted ,onClick}) => {
  return <div
    className={styles.p_option}
              onClick={onClick}>
    ...
    {selelcted?<img className={styles.pay_icon_right} src={selIcon} alt=''/> : <img className={styles.pay_icon_right} src={unselIcon} alt=''/>}
  </div>;
};
...
const PayContent = ({currentIndex=0,onClick})=>{
  return <div className={styles.order_content}>
