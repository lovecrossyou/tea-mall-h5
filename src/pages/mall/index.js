...
const FindTea = function() {
  return <div className={styles.tea_mall_nav}>
    <div className={styles.tea_mall_nav_left}>
      <NavBarList data={navList} activeCls={{color:"#333333",fontSize:"44px",borderBottom:"6px solid red"}}/>
    </div>
    <div className={styles.tea_mall_nav_right}>
      <div className={styles.found_btn_search_img}><img src={found_btn_search} alt=""/></div>
      <div>搜索</div>
    </div>
  </div>
};
...
const Product = function() {
  return <div className={styles.water_fail_product_item}>
    ...
    <div className={styles.water_fail_product_content}>
      ...
      <div className={styles.water_fail_product_intro}>茶艺修行之礼仪篇茶艺修行之礼仪篇</div>
...
export default class Mall extends PureComponent{
  render(){
    return <div className={styles.tea_mall_container}>
      <FindTea/>
