...
export default class Scroll extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (
      nextProps.horizontalWidth !== this.props.horizontalWidth &&
  ...
  render() {
    ...
    return (
      ...
      >
        {/* 滚动部分 */}
        <div
          className={cls(styles["scroll-content"], this.props.contentClassName)}
        ...
        {pullDownRefresh ? (
          <div
            className={styles["pulldown-wrapper"]}
            style={pullDownStyle}
            ref={c => (this.pulldown = c)}
          >
            {beforePullDown ? (
              <div className={styles["before-trigger"]}>
                <Bubble y={bubbleY} />
